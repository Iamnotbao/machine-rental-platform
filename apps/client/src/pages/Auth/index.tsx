...
import { mockLoginHint } from '@/features/auth/data/auth.mock';
import { authUiService } from '@/features/auth/services/auth-ui.service';
import { ROUTES } from '@/constants/route.constants';
import { authStore } from '@/store/auth/auth.store';
import styles from './page.module.css';

const rememberedUsername = localStorage.getItem('machine-rental-remembered-username') ?? '';
