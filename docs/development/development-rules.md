...
Keep documentation synchronized whenever architecture, folders, routing, data flow, business foundations, or workflow changes. PRs should be scoped, describe validation, and avoid unrelated changes. Client and Admin must be validated independently.
